...
public class Main0 {
    ...
    public static void main(String[] args) {
        ...
        com.hazelcast.spi.properties.HazelcastProperty Variable0 = new com.hazelcast.spi.properties.HazelcastProperty(PropertyKey, "");
        Variable0.setSystemProperty(JNDI_string);
